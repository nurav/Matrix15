...
/**
 * Created by The Joshis on 9/21/2015.
 */
...
public class EventCloud extends View {
    ...
    public EventCloud(Context context) {
        super(context);
        init();
    }

    public EventCloud(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public EventCloud(Context context, AttributeSet attrs, int defStyleAttr) {
